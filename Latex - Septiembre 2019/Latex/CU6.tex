\begin{UseCase}{CU6}{Consulta Calendario de Eventos}{
		...
		Para poder visualizar la tabla que muestra estos datos, el actor dará click en el botón \IUbutton{ Calendario } ubicados en la \IUref{}{Pantalla de Inicio de Sesión \ref{principalalum}}.
    ...
    \UCpaso[\UCactor] Oprime el botón \IUbutton{ Calendario } que esta en la \IUref{}{Pantalla de Inicio de Sesión \ref{principalalum}}.
    \UCpaso Muestra la \IUref{}{Pantalla de Inicio de Sesión \ref{principalJFD}} en la sección Calendario de Eventos.

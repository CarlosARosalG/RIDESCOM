			...
			<div class="card-body">
				<form>
					...
					<div class="form-group">
						<input type="submit" value="Entrar" href="principal.htm" class="btn btn-light float-right login_btn">
					</div>
                                    
                                        <div class="form-group">
						<input type="submit" value="Cancelar" href="principal.htm" class="btn btn-light float-right login_btn">
					</div>
				</form>
			</div>

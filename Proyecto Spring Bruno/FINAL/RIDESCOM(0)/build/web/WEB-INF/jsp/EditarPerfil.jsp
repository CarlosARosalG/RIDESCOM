	...
	<section id="global">
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate method="POST">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Nombre" value="${da[0].Nombre}" minlength="4" maxlength="45" disabled>
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Appat" value="${da[0].Ap_pat}" minlength="4" maxlength="45" disabled>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Apmat" value="${da[0].Ap_mat}" minlength="4" maxlength="45" disabled>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <input type="text" class="num form-control" id="validationTooltip02" name="NSS" minlength="4" maxlength="10" value="${da[0].NSS}">
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>

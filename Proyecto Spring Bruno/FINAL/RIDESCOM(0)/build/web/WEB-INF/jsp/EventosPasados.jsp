...
<html lang="es">
    ...
    <body id="fon">
        ...
        <section id="global">
            ...
            <header>
                <div id="logoi">
                    <a href="../" style='text-decoration:none;'><img src="../resources/img/ridescom.jpg" width="500"></a>
                </div>
                <div class="clearfix">	
                </div>
            </header>
            ...
            <nav id="bar">
                <ul>
                    ...
                    <li><a href="Entrenadores.html" style='text-decoration:none; color: #fff'><span class="segundo"><i class="fas fa-users"></i></span> Entrenadores </a></li>
                    <li><a href="DifundirEvento.html"><span class="tercero" style='text-decoration:none; color: #fff'><i class="fas fa-share-alt"></i></span> Difundir Evento </a></li>
                    <li><a href=""><span class="tercero" style='text-decoration:none; color: #fff'><i class="fas fa-share-alt"></i></span> Eventos Deportivos</a>
                    <ul>
                        <li><a href="../"style='text-decoration:none;'>Eventos Disponibles</a></li>
                        <li><a href="EventosPasados.html"style='text-decoration:none;'>Eventos Pasados</a></li>
                    </ul></li>
                    <li><a href="AlumnosInscritos.html"><span class="cuarto" style='text-decoration:none; color: #fff'><i class="fas fa-users"></i></span> Consulta Inscritos </a></li>
                    <li><a href="Cedula.html"><span class="cuarto" style='text-decoration:none; color: #fff'><i class="fas fa-users"></i></span> Cédulas de inscripción </a></li>
                    <li><a href="Resultados.html" style='text-decoration:none; color: #fff'><span class="sexto"><i class="fas fa-poll"></i></span> Resultados </a></li>
            ...
            <div class="container text-center">
                <h1>Eventos Interpolitécnicos Deportivos Realizados</h1>
            </div>
            <div class="col-row-8">

...
public class Alumno {
   ModelAndView mav=new ModelAndView();
    ...
    public ModelAndView Alumno(HttpServletRequest re){
        ...
        String sqlp="select u.Nombre_U, p.Nombre, p.Ap_Pat, p.Ap_Mat, s.Sexo, p.Fecha_Nac, p.CURP, p.NSS, ce.Correo, tf.Telefono\n" +
"	from persona p, Usuario u, contacto c, tipo_sexo s, email ce, telefono_fijo tf, Roles r\n" +
"		where r.ID_Roles='3'\n" +

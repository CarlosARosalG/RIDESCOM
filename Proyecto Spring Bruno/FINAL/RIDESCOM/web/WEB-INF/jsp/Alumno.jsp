...
<html lang="es">
    ...
    <body id="fon">
        <section id="global">
            ...
            <nav id="bar">
                <ul>
                    <li><a href="Alumno/Perfil.html" style='text-decoration:none; color: #fff'><span class="primero"><i class="fas fa-user"></i></span> Perfil </a>
                        <ul id="Usuario">
                            ...
                            <!--<li><a href="Alumno/EditarPerfil.html"style='text-decoration:none;'><span class="sexto"></span> Editar Perfil </a></li>-->
                    ...
                    <div class="timeline-item">
                        ...
                        <script>
                            ...
                            <div class="timeline-content js--fadeInLeft">
                                ...
                                Registrate: 
                                <a href="Alumno/Inscribirse.html?evento=${dato.Evento_ID}" class="edita bnt-more" style='text-decoration:none;color: #0174DF;'> 
...
<script>
                alert('Bienvenido a RIDESCOM\n\
            Aquí podrás ver los eventos interpolitécnicos disponibles.\n\
            Si no ves algún evento es porque la fecha de registro expiró.\n\
\n\
            AVISO: Si eres nuevo aquí, termina de registrar tu información en "Perfil"');
            </script>
</html>
...
<body>
	<section id="global">
		...
		<div class="col-12 ">
			<div id="noti" class="alert alert-info col-12" role="alert" style="alignment-adjust: central;">
			<p> 
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate method="POST">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Nombre" value="${da[0].Nombre}" minlength="3" maxlength="45" required>
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Appat" value="${da[0].Ap_pat}" minlength="4" maxlength="45" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Apmat" value="${da[0].Ap_mat}" minlength="4" maxlength="45" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="CURP" value="${da[0].CURP}" minlength="18" maxlength="18" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <input type="text" class="num form-control" id="validationTooltip02" name="NSS" minlength="4" maxlength="15" value="${da[0].NSS}">
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
                            ...
                            <input name="Nacimiento" type="text" class="fec form-control" id="datepicker" value="${da[0].Fecha_Nac}" required/>
                            <div class="valid-tooltip">
				    	OK
				    </div>
                        </div>
				    ...
				    <div class="valid-tooltip">
				    	OK
                            ...
                            <div class="col-md-4 mb-3">
				    <label for="validationTooltip02"> Municipio/Alcaldía </label><span style="color: #ff0000">*</span>
<!--				    <input type="text" class="form-control" id="validationTooltip02" value="Buscar..." required>-->
                                    <select name="municipio" id="mun" class="custom-select" style="width: 340px;" required>
				    ...
				    <label for="validationTooltip02"> Correo </label><span style="color: #ff0000">*</span>
                                    <input type="text" class="form-control" id="validationTooltip02" name="Correo" value="${da[0].Correo}" maxlength="45" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip02"> Teléfono de contacto (mínimo 8 dígitos) </label><span style="color: #ff0000">*</span>
                                    <input type="text" class="num form-control" id="validationTooltip02" name="Tel_fijo" value="${da[0].Telefono}"minlength="8" maxlength="10" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <label for="validationTooltip02"> Extensión (Opcional) </label>
                                    <input type="text" class="num form-control" id="validationTooltip02" onkeypress="return validarSiNumero()" name="Ext" value="${da[0].Ext}" maxlength="10">
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <label for="validationTooltip02"> Teléfono Móvil (Opcional) </label>
                                    <input type="text" class="num form-control" id="validationTooltip02" name="Tel_cel" maxlength="15" value="${da[0].Celular}">
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
...
<!--					  <option value="">Seleccione Escuela</option>-->
                    ...
                    <a href="../Usuarios.html"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn btn-outline-danger"> Volver </button></a>
                </form>
		<div class="clearfix" >&nbsp;</div>
	</section>
</body>

                ...
                <form class="needs-validation" novalidate >
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="Nombre_E" type="text" id="validationTooltip01" class="form-control" value="${eve[0].Nombre_Evento}" maxlength="300" disabled/>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="FE" type="text" class="form-control" id="datepicker" value="${eve[0].Fecha_Evento}" disabled/>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="FFR" type="text" class="form-control" id="datepicker2" value="${eve[0].Fecha_fin_Registro}" disabled/>
                            <script>
                                var today, datepicker;
                                today = new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate()+1);
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="ciclo" id="selectsport" class="custom-select" style="width: 150px;" disabled/>
...
<!--                            <input name="ciclo" type="text" class="form-control" id="validationTooltip02" placeholder="YYYY/1-2" disabled>-->
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="sede" id="selectsport" class="custom-select" style="width: 300px;" disabled/>
                    ...
                    <div>
                        ...
                        <div class="col-md-3 mb-3">
                                <select name="deporte" id="selectsport" class="custom-select" style="width: 380px;" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="Desc" onkeyup="countChars(this);" class="form-control" id="exampleFormControlTextarea1" rows="2" maxlength="200" readonly="readonly">${eve[0].Descripcion}</textarea>

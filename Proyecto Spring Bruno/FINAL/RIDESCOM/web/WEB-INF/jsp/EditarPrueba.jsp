                ...
                <form class="needs-validation" novalidate method="POST">
                    <div class="form-row">
					  ...
					  <option value="${prue[0].ID_Deporte}">${prue[0].Disciplina}</option>
                                                    <%
                                                        try{
                                                            String query="select * from Act_Deportiva order by Disciplina ASC";
                                                            Class.forName("com.mysql.jdbc.Driver").newInstance();
                                                            Connect conn = new Connect();
                                                            Statement stm=conn.Connect().createStatement();
                                                            ResultSet rs=stm.executeQuery(query);
...
<!--                    <a href="../Pruebas/ConfirmaEdicion.html?PruebaID=${prue[0].ID_Pruebas}" type="submit" value="Agregar" class="btn btn-outline-success"></a>-->

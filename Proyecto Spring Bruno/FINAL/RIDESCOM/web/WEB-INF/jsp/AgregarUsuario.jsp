	...
	<section id="global">
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate method="POST">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Nombre" placeholder="Nombre" minlength="3" maxlength="45" required/>
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Appat" placeholder="Apellido Paterno" minlength="3" maxlength="45" required/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Apmat" placeholder="Apellido Materno" minlength="3" maxlength="45" required/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <input type="text" class="num form-control" id="validationTooltip02" name="NSS" placeholder="NSS" minlength="15" maxlength="45" />
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>

...
<head>
	<meta charset="utf-8">
	<title> Editar información de un deporte </title>
...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Editar información acerca de un deporte </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-info col-12" role="alert" style="alignment-adjust: central;">
			  <p> Aquí podrás editar información de una disciplina deportiva. </p>
...
<!--                    <a href="../Deportes/ConfirmaDeporte.html?DeporteID=${dep[0].ID_Deporte}" type="submit" value="Agregar" class="btn btn-outline-success">Agregar</a>-->

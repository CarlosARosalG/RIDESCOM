...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Edita resultados de participante </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-info col-12" role="alert">
			<p> 
			  Ingresa los resultados del participantes.
		...
		<!-- Formulario --> 
			...
			<div class="form-row">
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip01"><i class="fas fa-id-card"></i> Boleta </label>
                                    <input name="Boleta" type="text" id="validationTooltip01" class="form-control" value="${alu[0].Alumno_ID_Alumno}" maxlength="10" readonly="readonly"/>
				</div>
			</div>
			...
			<div class="form-row">
				<div class="col-md-4 mb-3">
				    ...
				    <input type="text" id="validationTooltip02" class="form-control" value="${alu[0].Nombre}" maxlength="10" disabled>
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip03"><i class="fas fa-user"></i> Apellido Paterno </label>
                                    <input type="text" id="validationTooltip03" class="form-control" value="${alu[0].Ap_Pat}" maxlength="10" disabled>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip04"><i class="fas fa-user"></i> Apellido Materno </label>
                                    <input type="text" id="validationTooltip04" class="form-control" value="${alu[0].Ap_Mat}" maxlength="10" disabled>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
		    	<div class="col-md-4 mb-3">
			    	<label for="validationTooltip05"><i class="fas fa-graduation-cap"></i> Escuela </label>
                                <input type="text" id="validationTooltip05" class="form-control" value="${alu[0].Escuela}" maxlength="10" disabled>
			    	<div class="invalid-feedback">
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip06"><i class="fas fa-graduation-cap"></i> Carrera </label>
                                    <input type="text" id="validationTooltip06" class="form-control" value="${alu[0].Programa}" maxlength="10" disabled>
                                    <div class="invalid-feedback">
                                        Ingresa un carrera
                                    </div>
			    </div>
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip09"><i class="fas fa-trophy"></i> Posición </label>
                                    <input name="Posicion" type="text" id="validationTooltip09" class="form-control" value="${alu[0].Lugar_Obtenido}" maxlength="10" required/>
				    <div class="invalid-feedback">
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip11"> Resultado </label>
                                    <input name="Marca" type="text" id="validationTooltip11" class="form-control" value="${alu[0].Marca}" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa una marca
                                    </div>
			    </div>

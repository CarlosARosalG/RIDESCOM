...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Edita la información de una sede </h1>
		</div>
		...
		<!-- Formulario --> 
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip02"> Nombre del lugar </label>
                                    <input type="text" class="form-control" id="validationTooltip02" name="Sede" value="${sed[0].Nombre_S}" maxlength="50" equired/>
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Calle" value="${sed[0].Calle}" maxlength="100" equired/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Colonia" value="${sed[0].Colonia}" maxlength="100" equired/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Numero" value="${sed[0].Numero}" maxlength="5">
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
...
<!--				    <input type="text" class="form-control" id="validationTooltip02" placeholder="Buscar..." required>-->
		  	...
		  	<a href="../Sedes.html"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn  btn-outline-danger"> Volver </button></a>
		</form>
	</section>
</body>

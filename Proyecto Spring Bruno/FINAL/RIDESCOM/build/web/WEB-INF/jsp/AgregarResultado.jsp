...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Ingresa resultados del participante</h1>
		</div>
		...
		<!-- Formulario --> 
			...
			<div class="form-row">
				<div class="col-md-4 mb-3">
				    ...
				    <input type="text" id="validationTooltip02" class="form-control" value="${r.Nombre}" maxlength="10" disabled>
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip03"><i class="fas fa-user"></i> Apellido Paterno </label>
                                    <input type="text" id="validationTooltip03" class="form-control" value="${r.Ap_Pat}" maxlength="10" disabled>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip04"><i class="fas fa-user"></i> Apellido Materno </label>
                                    <input type="text" id="validationTooltip04" class="form-control" value="${r.Ap_Mat}" maxlength="10" disabled>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip06"><i class="fas fa-graduation-cap"></i> Carrera </label>
                                    <input type="text" id="validationTooltip06" class="form-control" value="${r.Programa}" maxlength="10" disabled>
                                    <div class="invalid-feedback">
                                        Ingresa un carrera
                                    </div>
			    </div>
			...
			<div>
					  ...
					  <option value="">Seleccione prueba...</option>
                                          <c1:forEach var="pr" items="${prueba}">
                                            <option value="${pr.Evento_Evento_ID}">${pr.Prueba} - ${pr.Disciplina} - ${pr.Rama}</option>
                                          </c1:forEach>
                                </select>
                            <div class="invalid-feedback">
                                Ingresa una Prueba
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip11">Resultado </label><span style="color: #ff0000">*</span>
                                    <input name="Marca" type="text" id="validationTooltip11" class="form-control" placeholder="Resultado" maxlength="10" required/>
				    <div class="invalid-feedback">

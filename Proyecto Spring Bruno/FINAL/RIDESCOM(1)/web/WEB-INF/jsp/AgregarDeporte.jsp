...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Agrega un nuevo deporte que participe en los interpolitécnicos </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-info col-12" role="alert" style="alignment-adjust: central;">
			  <p> Aquí podrás registrar las disciplinas deportivas. </p>
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate method="POST">
                    ...
                    <a href="../Deportes.html"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn  btn-outline-danger"> Volver </button></a>
                </form>
	</section>
</body>

...
<head>
	<meta charset="utf-8">
	<title> Agrega información una sede </title>
...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Agrega una nueva sede </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-info col-12" role="alert">
			  <p> Aquí podrás registrar el nombre y dirección de la sede donde se realicen interpolitécnicos deportivos. </p>

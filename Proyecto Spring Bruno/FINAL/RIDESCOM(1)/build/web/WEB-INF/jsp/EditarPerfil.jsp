...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Edita la información de tu perfil</h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-info col-12" role="alert">
			<p> 
			  Verifica que no falte ningún campo por completar antes de guardar tu información.
			</p>
			</div>
		</div>
            <div class="form-row"> 
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate method="POST">
				    ...
				    <input type="text" class="form-control" id="curp_input" oninput="validarInput(this)" name="CURP" value="${ad.CURP}" minlength="18" maxlength="18" required/>
				    ...
				    <div class="valid-tooltip">
				    	OK
                            ...
                            <div class="col-md-4 mb-3">
				    <label for="validationTooltip02"> Folio de Seguro Social </label><span style="color: #ff0000">*</span>
                                    <input type="text" class="form-control" id="validationTooltip02" name="NSS" value="${ad.NSS}" minlength="4" maxlength="45" required/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
                            ...
                            <input name="Nacimiento" type="text" class="fec form-control" id="datepicker" value="${ad.Fecha_Nac}" maxlength="10" autocomplete="off" required/>
                        </div>
                            <div class="col-md-4 mb-3">
				    ...
				    <select name="Sexo" class="custom-select" style="width: 150px;" required/>
					  <option value="${ad.Tipo_Sexo_ID_Tipo_Sexo}">${ad.Sexo}</option>
                                                    <%
                                                        try{
...
<!--				    <input type="text" class="form-control" id="validationTooltip02" placeholder="Buscar..." required>-->
					  ...
					  <option value="${ad.ID_Municipio}">${ad.Municipio}-${ad.Estado}</option>
                                                    <%
                                                        try{
				    ...
				    <label for="validationTooltip02"> Correo </label><span style="color: #ff0000">*</span>
                                    <input type="text" class="email form-control" id="validationTooltip02" name="Correo" value="${ad.Correo}" required/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip02"> Teléfono de contacto (minimo 8 dígitos) </label><span style="color: #ff0000">*</span>
                                    <input type="text" class="num form-control" id="validationTooltip02" onkeypress="return validarSiNumero()" name="Tel_fijo" value="${ad.Telefono}" minlength="8" maxlength="10" required/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <label for="validationTooltip02"> Teléfono Móvil (Opcional) </label>
                                    <input type="text" class="num form-control" id="validationTooltip02" onkeypress="return validarSiNumero()" name="Tel_cel" value="${ad.Celular}" minlength="10" maxlength="15">
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
                    ...
                    <a href="Perfil.html"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn btn-outline-danger"> Volver </button></a>

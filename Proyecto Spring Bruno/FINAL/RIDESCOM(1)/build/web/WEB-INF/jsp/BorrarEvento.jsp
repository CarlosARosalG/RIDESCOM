...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Confirma la eliminación de un evento interpolitécnico deportivo </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-warning col-12" role="alert">
			  <p> Aquí podrás eliminar un nuevo evento interpolitécnico deportivo. </p>
                ...
                <form class="needs-validation" novalidate>
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="Nombre_E" type="text" id="validationTooltip01" class="form-control" placeholder="${eve[0].Nombre_Evento}" maxlength="300" disabled/>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="FIR" type="text" class="form-control" id="datepicker1" placeholder="${eve[0].Fecha_inicio_Registro}" disabled>
                            
                            <label for="validationTooltip03"> Fecha limite para registrarse </label>
                            <input name="FFR" type="text" class="form-control" id="datepicker2" placeholder="${eve[0].Fecha_fin_Registro}" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip02"> Semestre </label>
<!--                                <select name="ciclo" id="selectsport" style="width: 150px;">
					  <option value="">Ciclo escolar</option>
                            ...
                            <input name="ciclo" type="text" class="form-control" id="validationTooltip02" placeholder="${eve[0].Ciclo_Escolar}" disabled/>
                            <div class="invalid-feedback">
                                Elige el ciclo correspondiente
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
...
<!--                                <select name="deporte" id="selectsport" style="width: 380px;">
					  <option value="">Deporte</option>
                                                    <%
                                                        try{
                                                            String query="select ID_Pruebas, Prueba, Disciplina from pruebas pr inner join (Act_Deportiva d)on(pr.Act_Deportiva_ID_Deporte=d.ID_Deporte)";
                                                            Class.forName("com.mysql.jdbc.Driver").newInstance();
                                                            Connect conn = new Connect();
                                                            Statement stm=conn.Connect().createStatement();
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next()){
                                                                %>
                                                                <option value="<%=rs.getInt("ID_Deporte")%>"><%=rs.getString("Prueba")%><%=rs.getString("Disciplina")%></option>
                                                                <%
                                                            }
                            ...
                            <input name="Disciplina" type="text" class="form-control" id="validationTooltip02" placeholder="${eve[0].Prueba}" disabled/>
                            <div class="invalid-feedback">
                                Ingresa un deporte
                            </div>
                        </div>

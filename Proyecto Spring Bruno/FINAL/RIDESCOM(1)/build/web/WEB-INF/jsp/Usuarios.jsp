						...
						<tbody id="datos">
							<c:forEach var="d" items="${coo}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>${d.Nombre}</td>
                                                            <td>${d.Correo}</td>
                                                            <td>${d.telefono} <a id="exten">Ext. ${d.Ext}</a></td>
                                                            <td>${d.Celular}</td>
                                                            <td>${d.Activo}</td>
                                                            ...
                                                            <td> 
                                                                    <a href="Usuarios/BorrarUsuario.html?UsuarioID=${d.ID_Persona}" class="borra" style='text-decoration:none;color: red;'> 
...
<script type="text/javascript">
    ...
    if (!confirm('¿Está seguro de borrar este usuario?')) e.preventDefault();
    };

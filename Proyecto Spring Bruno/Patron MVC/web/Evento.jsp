	...
	<!-- Calendario -->
		...
		<h2 id="titulo">Calendario de eventos</h2>
			<div class="container">
				<div class="col-row-8">
					<!-- The second
     value will be selected initially -->
                                        <div><label>Filtrar por deporte</label></div>
				...
				<div class="table-responsive">
					<table id="tabla" class="table table-hover">
						<thead>
							<tr>
								<th scope="col"> Evento 
                                                                    <a href="Agregard.jsp" style='text-decoration:none;color: green;'> 
                                                                        <i class="far fa-plus-square"></i> 
                                                                    </a> 
                                                                </th>
                                                                <th scope="col"> Deporte </th>
                                                                <th scope="col"> Fecha de inicio del registro </th>
								<th scope="col"> Fecha de fin de registro </th>
								<th scope="col"> Sede del evento </th>
						...
						<tbody>
                                                    <c:forEach var="ev" items="${Evento}">
                                                    <tr>
								<th>${ev.Nombre_Evento}</th>
								<td>${ev.Disciplina}</td>

...
<html>
    ...
    <body>
        <section id="global">
		<div id="titulo">
			<h1> Registra nuevo usuario coordinador </h1>
		</div>
                ...
                <form class="needs-validation" novalidate>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="textuser" id="validationTooltip01" class="form-control" placeholder="Usuario" maxlength="20" required/>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="password" name="textpass" id="validationTooltip02" class="form-control" placeholder="Contraseña" maxlength="16" required/>
                            <div class="invalid-feedback">
...
<!--                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip03">Residencia Actual</label>
                    ...
                    <form action="Coordinador" method="POST">
                        <button type="submit" name="accion" value="Registrar" class="btn  btn-outline-success "> Registrar </button>    
                        <a href="" style='text-decoration:none;color: #FFFFFF;'> <button type="button" name="Salir" class="btn btn-outline-danger"> Cancelar </button></a>
                    </form>

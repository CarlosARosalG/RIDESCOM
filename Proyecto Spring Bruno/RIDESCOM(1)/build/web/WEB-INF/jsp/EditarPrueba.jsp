...
<head>
	<meta charset="utf-8">
	<title> Editar información de una prueba </title>
...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Editar información acerca de una prueba </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-warning col-4" role="alert">
			  <p> Aquí podrás editar información de la prueba deportiva. </p>
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate method="POST">
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <select name="Tipo" id="selectsport" style="width: 380px;" autocomplete="off">
					  <option value="">Tipo de prueba</option>
                        ...
                        <div >
                            <select name="Act_Prueba" id="selectsport" style="width: 380px;" autocomplete="off">
...
<!--                    <a href="../Pruebas/ConfirmaEdicion?PruebaID=${prue[0].ID_Pruebas}" type="submit" value="Agregar" class="btn btn-outline-success"></a>-->
                    <button name="Agrega" class="btn   btn-outline-success" value="Agregar" type="submit"> Agregar </button>
                    <a href="../Pruebas"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn  btn-outline-danger"> Cancelar </button></a>
                </form>
	</section>
</body>

	...
	<section id="global">
		...
		<div class="col-12 ">
			<div id="noti" class="alert alert-warning col-4" role="alert">
			  <p> Aquí podrás de alta un nuevo evento interpolitécnico deportivo. </p>
			...
			<form class="needs-validation" novalidate method="POST">
				<div class="form-row">
			    	<div class="col-md-4 mb-3">
					     ...
					     <input name="Nombre_E" type="text" class="form-control" id="validationTooltip01" placeholder="Nombre evento" required>
					     <div class="valid-tooltip">
					     	OK
					     </div>
			    	</div>
			    	<div class="col-md-4 mb-3">
				    	<label for="validationTooltip02"> Fecha del evento </label>
				    	<input name="Fecha_fin" type="text" class="form-control" id="validationTooltip02" placeholder="Fecha del evento (YYYY-MM-DD)" required>
				    	<div class="valid-tooltip">
				      		OK
				    	</div>
				    </div>
				    <div class="col-md-4 mb-3">
					    <label for="validationTooltip02"> Fecha inicio de registro </label>
					    <input name="Fecha_in" type="text" class="form-control" id="validationTooltip02" placeholder="Fecha inicio de registro (YYYY-MM-DD)" required>
					    <div class="valid-tooltip">
					    	OK
					    </div>
				    </div>
				    <div class="col-md-4 mb-3">
					    <label for="validationTooltip02"> Fecha fin de registro </label>
					    <input name="Fecha_in" type="text" class="form-control" id="validationTooltip02" placeholder="Fecha fin de registro (YYYY-MM-DD)" required>
					    <div class="valid-tooltip">
					    	OK
					    </div>
				    </div>
			  	...
			  	<div class="form-row">
				  	<div class="col-md-3 mb-3">
				    	<label for="validationTooltip04">Lugar</label>
					    <input name="Lugar" type="text" class="form-control" id="validationTooltip04" placeholder="Lugar de realización" required>
				    </div>
				    <div class="col-md-3 mb-3">
					    <label for="validationTooltip05">Ciclo Escolar</label>
					    <input type="text" class="form-control" id="validationTooltip05" placeholder="YYYY/1-2" required>
				    </div>
					...
					<div class="col-md-3 mb-3">
						...
						<select id="deporte" class="custom-select">
                                                    <c:forEach name="Disciplina" var="dat" items="${rid}">
							
                                                        <option selected>Selecciona un deporte</option>
					  		<option value="${dat.ID_Deporte}">${dat.Disciplina}</option>

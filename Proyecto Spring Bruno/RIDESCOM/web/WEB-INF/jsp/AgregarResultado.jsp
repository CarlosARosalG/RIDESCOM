...
<head>
	<head>
	<meta charset="utf-8">
	<title> Ingresa Resultados </title>
		...
		<form class="needs-validation" novalidate method="POST">
			<div class="form-row">
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip01"><i class="fas fa-id-card"></i> Boleta </label>
                                    <input type="text" id="validationTooltip01" class="form-control" placeholder="Boleta" maxlength="10" required/>
			...
			<div class="form-row">
				<div class="col-md-4 mb-3">
				    ...
				    <input type="text" id="validationTooltip02" class="form-control" placeholder="Nombre" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa un nombre
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip03"><i class="fas fa-user"></i> Apellido Paterno </label>
                                    <input type="text" id="validationTooltip03" class="form-control" placeholder="Apellido Peterno" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip04"><i class="fas fa-user"></i> Apellido Materno </label>
                                    <input type="text" id="validationTooltip04" class="form-control" placeholder="Apellido Materno" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
		    	<div class="col-md-4 mb-3">
			    	<label for="validationTooltip05"><i class="fas fa-graduation-cap"></i> Escuela </label>
                                <input type="text" id="validationTooltip05" class="form-control" placeholder="Escuela" maxlength="10" required/>
			    	<div class="invalid-feedback">
                                    Ingresa una unidad acádemica
                                </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip06"><i class="fas fa-graduation-cap"></i> Carrera </label>
                                    <input type="text" id="validationTooltip06" class="form-control" placeholder="Carrera" maxlength="10" required/>
                                    <div class="invalid-feedback">
                                        Ingresa un carrera
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip07"><i class="fas fa-walking"></i> Deporte </label>
                                    <input type="text" id="validationTooltip07" class="form-control" placeholder="Deporte" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa un deporte
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip08"><i class="fas fa-walking"></i> Sub-división </label>
                                    <input type="text" id="validationTooltip08" class="form-control" placeholder="Sub-división" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa una sub-división
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip09"><i class="fas fa-trophy"></i> Posición </label>
                                    <input type="text" id="validationTooltip09" class="form-control" placeholder="Posicion" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa una posición
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip10"><i class="fas fa-walking"></i> Prueba </label>
                                    <input type="text" id="validationTooltip10" class="form-control" placeholder="Prueba" maxlength="10" required/>
				    <div class="invalid-feedback">
                                        Ingresa una prueba
                                    </div>
			    </div>

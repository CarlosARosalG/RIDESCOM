...
<!--                                                            <td>${dato.Evento_ID}</td>-->
                                                            ...
                                                            <td> 
                                                                    <a href="DDyFD/EditarEvento?EventoID=${dato.Evento_ID}" id="edita" style='text-decoration:none;color: #0174DF;'> 
...
<!--                                                            <td> 
        ...
        <!-- Usuarios -->
                <a name="Usuarios" id="Usuarios"></a>
		<h2 id="titulo">Consulta coordinadores de U.A.</h2>
                <div id="agregaboton">
                    <label> Para agregar un nuevo coordinador pulsa aquí: </label>
                    <a href="DDyFD/AgregarUsuario" style='text-decoration:none;color: #777620; align-content: right;'> 
                        <i class="far fa-plus-square fa-2x"></i> 
                    </a> 
                </div>
                <div class="container">
						...
						<tbody>
							<c:forEach var="d" items="${coo}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                    <a href="DDyFD/EditarUsuario?UsuarioID=${d.ID_Persona}" style='text-decoration:none;color: #0174DF;'> 
                                                                        <i class="far fa-edit"></i>  
                                                                    </a> 
                                                            </td>
		...
		<div class="container">
			<div class="cuadro">
				...
				<div class="box">
					...
					<div class='details'><h3>${p.Correo}</h3></div>
				</div>
			</div>
		</div>
		<div class="clearfix" >&nbsp;</div>

		...
		<!-- Formulario --> 
			...
			<div class="form-row">
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip01"><i class="fas fa-id-card"></i> Boleta </label>
                                    <input type="text" id="validationTooltip01" class="form-control" placeholder="Boleta" maxlength="10" disabled/>
				</div>
			</div>
			...
			<div class="form-row">
				<div class="col-md-4 mb-3">
				    ...
				    <input type="text" id="validationTooltip02" class="form-control" value="Nombre" maxlength="10" disabled>
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip03"><i class="fas fa-user"></i> Apellido Paterno </label>
                                    <input type="text" id="validationTooltip03" class="form-control" value="Apellido Peterno" maxlength="10" disabled>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip04"><i class="fas fa-user"></i> Apellido Materno </label>
                                    <input type="text" id="validationTooltip04" class="form-control" value="Apellido Materno" maxlength="10" disabled>
				    <div class="invalid-feedback">
                                        Ingresa un apellido
                                    </div>
			    </div>
		    	<div class="col-md-4 mb-3">
			    	<label for="validationTooltip05"><i class="fas fa-graduation-cap"></i> Escuela </label>
                                <input type="text" id="validationTooltip05" class="form-control" value="Escuela" maxlength="10" disabled>
			    	<div class="invalid-feedback">
			    ...
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip06"><i class="fas fa-graduation-cap"></i> Carrera </label>
                                    <input type="text" id="validationTooltip06" class="form-control" value="Carrera" maxlength="10" disabled>
                                    <div class="invalid-feedback">
                                        Ingresa un carrera
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip07"><i class="fas fa-walking"></i> Deporte </label>
                                    <input type="text" id="validationTooltip07" class="form-control" value="Deporte" maxlength="10" disabled>
				    <div class="invalid-feedback">
                                        Ingresa un deporte
                                    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip08"><i class="fas fa-walking"></i> Sub-división </label>
                                    <input type="text" id="validationTooltip08" class="form-control" value="Sub-división" maxlength="10" disabled>
				    <div class="invalid-feedback">

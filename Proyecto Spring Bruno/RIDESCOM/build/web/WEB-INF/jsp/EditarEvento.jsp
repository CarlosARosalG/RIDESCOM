	...
	<section id="global">
		...
		<div class="col-12 ">
			<div id="noti" class="alert alert-warning col-4" role="alert">
			  <p> Aquí podrás editar un nuevo evento interpolitécnico deportivo. </p>
                ...
                <form class="needs-validation" novalidate>
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="Nombre_E" type="text" id="validationTooltip01" class="form-control" placeholder="${eve[0].Nombre_Evento}" maxlength="300" required/>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="FE" type="text" class="form-control" id="datepicker" placeholder="${eve[0].Fecha_Evento}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="FIR" type="text" class="form-control" id="datepicker1" placeholder="${eve[0].Fecha_inicio_Registro}" required>
                            <script>
                            ...
                            <input name="FFR" type="text" class="form-control" id="datepicker2" placeholder="${eve[0].Fecha_fin_Registro}" required>
                            <script>
...
<!--                            <input name="ciclo" type="text" class="form-control" id="validationTooltip02" placeholder="YYYY/1-2" disabled>-->
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="Lugar" type="text" class="form-control" id="validationTooltip04" placeholder="${eve[0].Lugar_del_Evento}" maxlength="200" required>
                            <div class="invalid-feedback">
                                Ingresa un usuario
                            </div>
                        </div>
                      <div class="col-md-8 mb-3">
                            ...
                            <input name="Dir" type="text" class="form-control" id="validationTooltip02" placeholder="${eve[0].Direccion}" maxlength="150" required/>
                            <div class="invalid-feedback">
                                Ingresa un usuario
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="P_Ref" type="text" class="form-control" id="validationTooltip04" placeholder="${eve[0].P_Referencia}" maxlength="100" required/>
                            <div class="invalid-feedback">
                                Ingresa un usuario
                            </div>
                        </div>

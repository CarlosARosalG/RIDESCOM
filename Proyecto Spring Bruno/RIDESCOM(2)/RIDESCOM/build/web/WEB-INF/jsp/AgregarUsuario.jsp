...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Agrega un nuevo usuario coordinador de UA</h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-warning col-4" role="alert">
			  <p> Aquí podrás registrar los usuarios de unidad académica. </p>
                ...
                <form class="needs-validation" novalidate method="POST">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip01"> Nombre de Usuario </label>
                            <input type="text" name="Nombre_U" id="validationTooltip01" class="form-control" onkeypress="return soloLetras(event)" placeholder="Nombre de Usuario" maxlength="30" required/>
                            <div class="invalid-feedback">
                                Ingresa un nombre de usuario
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip01"> Contraseña de Usuario </label>
                            <input type="text" name="Password_U" id="validationTooltip01" class="form-control"  placeholder="Contraseña" maxlength="16" required/>
                            <div class="invalid-feedback">
                                Ingresa una Contraseña
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip01"> Confirme la contraseña </label>
                            <input type="text" name="confirmar" id="validationTooltip01" class="form-control" placeholder="Contraseña" maxlength="16" required/>
                            <div class="invalid-feedback">
                                Ingresa una Contraseña
                            </div>
                        </div>

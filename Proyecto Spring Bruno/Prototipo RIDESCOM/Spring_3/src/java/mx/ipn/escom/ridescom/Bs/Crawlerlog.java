...
public class Crawlerlog {
    Crawlerdat crwd = new Crawlerdat();
	...
	public String downloadCaptcha()throws Exception {
            ...
            String a = res.parse().getElementById("c_default_ctl00_leftcolumn_loginuser_logincaptcha_CaptchaImage").select("img").attr("src");
            if (a == null) {
	...
	public void run() throws Exception, IOException {
	    ...
	    //Parametros de entrada del Form LOGIN.JSP
             ...
             this.regno = crwd.getRegno();
	     this.passwd = crwd.getPasswd(); 
	     this.vrfcd = crwd.getVrfcd();

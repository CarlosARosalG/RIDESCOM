        ...
        <div class="container">
            <div class="col-row-12">
                <div id="agregaboton">
                        ...
                        <a href="Resultados/IngresaBoleta.html" style='text-decoration:none;color: #777620; align-content: right;'> 
                    ...
                    <tbody id="datos">
							<c:forEach var="ins" items="${ins}">
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                    <a href="Resultados/EditarResultado.html?ResulID=${ins.ID_Resultados}" style='text-decoration:none;color: #0174DF;'> 

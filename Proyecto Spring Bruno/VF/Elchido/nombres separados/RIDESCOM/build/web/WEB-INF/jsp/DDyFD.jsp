...
<html lang="es">
    <head>
        ...
        <style type="text/css">
            ...
            * {
            ...
            <script type="text/javascript" src="resources/js/timeline1.js"></script>
        ...
        <section id="global">
            ...
            <nav id="bar">
                <ul>
                    ...
                    <li><a href="DDyFD/Usuarios.html" style='text-decoration:none; color: #fff'><span class="segundo"><i class="fas fa-users"></i></span> Coordinadores </a></li>
    ...
    <script type="text/javascript">
                                    ...
                                    var confirmIt = function (e) {
                                        if (!confirm('¿Está seguro de borrar este evento?')) e.preventDefault();
                                    };

	...
	<section id="global">
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate method="POST">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" onkeypress="return soloLetras(event)" name="Nombre" value="${da[0].Nombre}" minlength="4" maxlength="45" required>

...
<!--                                 <td>${dato.ID_Deporte}</td>-->
                                ...
                                <td> 
                                                                ...
                                                                <td> 
                                                                    <a href="Deportes/BorrarDeporte.html?DeporteID=${dato.ID_Deporte}" class="borra" style='text-decoration:none;color: red;'>
...
<script type="text/javascript">
    ...
    if (!confirm('¿Está seguro de borrar este deporte?')) e.preventDefault();
    };

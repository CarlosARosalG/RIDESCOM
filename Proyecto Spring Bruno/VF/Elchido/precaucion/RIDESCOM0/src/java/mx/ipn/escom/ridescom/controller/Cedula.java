...
public class Cedula {
    ...
    @RequestMapping(value="Coordinador/Cedula.html", method=RequestMethod.GET)
    public ModelAndView Cedula(HttpServletRequest re){   
...
"INNER JOIN (alumno a, inscripcion i, Escuela es, evento ev, act_deportiva d, pruebas pr, ciclo ci) "
    ...
    @RequestMapping(value="Coordinador/Cedula.html", method=RequestMethod.POST)
    public ModelAndView Ced(HttpServletRequest request, HttpServletResponse response,Ced cd) throws JRException, IOException{   
...
//            outputstream.write(bytes1, 0, bytes1.length);
        ...
        return new ModelAndView("redirect:/Coordinador/Cedula.html");
    }

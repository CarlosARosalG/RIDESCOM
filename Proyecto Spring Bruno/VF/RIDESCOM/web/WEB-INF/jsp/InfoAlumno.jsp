...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Registra tu información personal restante </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-danger col-6" role="alert">
			  <p> Verifica tus datos sean correctos, en caso contrario acude al departamento de gestión escolar de tu unidad acádemica. </p>
			</div>
		</div>
		...
		<form class="needs-validation" novalidate method="POST">
			<div class="form-row">
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" value="Apellido Paterno" disabled/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    ...
			    <div class="col-md-4 mb-3">
				     ...
				     <input type="text" class="form-control" id="validationTooltip01" value="CURP" required/>
				     <div class="valid-tooltip">
				     	OK
				     </div>
		    	</div>
		    	<div class="col-md-4 mb-3">
			    	...
			    	<input type="text" class="form-control" id="validationTooltip02" value="Escuela" required/>
			    	<div class="valid-tooltip">
			      		OK
			    	</div>
			    </div>

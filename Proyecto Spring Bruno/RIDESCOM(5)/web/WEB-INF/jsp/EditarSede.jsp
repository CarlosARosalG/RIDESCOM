			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <div class="valid-tooltip">
				    	OK
                            ...
                            <div class="col-md-4 mb-3">
				    <label for="validationTooltip02"> Municipio en el que se localicé la sede </label>
<!--				    <input type="text" class="form-control" id="validationTooltip02" placeholder="Buscar..." required>-->
		  	...
		  	<a href="../Sedes"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn  btn-outline-danger"> Cancelar </button></a>
		</form>
	</section>
</body>

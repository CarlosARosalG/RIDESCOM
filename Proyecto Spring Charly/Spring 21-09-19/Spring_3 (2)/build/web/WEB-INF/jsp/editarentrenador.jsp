...
<head>
	<head>
	<meta charset="utf-8">
	<title> Editar datos de un entrenador </title>
...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Edita datos de un entrenador </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-dark col-4" role="alert">
			  <p> Edita datos de un entrenador que labore en la Unidad Acádemica. </p>
		...
		<form class="needs-validation" novalidate method="POST">
			<div class="form-row">
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Ap_Pat" placeholder="Apellido Patarno" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Ap_Mat" placeholder="Apellido Materno" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Genero" placeholder="Hombre/Mujer" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Municipio" placeholder="Municipio" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" name="Fecha_Nac" placeholder="YYY-MM-DD" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    <label for="validationTooltip02"> Teléfono de contacto </label>
                                    <input type="text" class="form-control" id="validationTooltip02" name="Tel" placeholder="Telefono movil" required>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
...
<!--			    <div class="col-md-5 mb-3">
					<label for="validationTooltip03">Unidad Acádemica</label>
					<select id="deporte" class="custom-select" required>
						<option selected>Selecciona una unidad acádemica</option>

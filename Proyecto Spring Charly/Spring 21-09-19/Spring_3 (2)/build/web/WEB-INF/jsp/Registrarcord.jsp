...
<head>
	<head>
	<meta charset="utf-8">
	<title> Registra un coordinador de una Unidad Académica </title>
...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Registra a un coordinador </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-danger col-6" role="alert">
			<p> 
			  Ingresa los resultados del coordinador de la Unidad Académica.
                ...
                <form class="needs-validation" novalidate>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="validationTooltip01" class="form-control" placeholder="Usuario" maxlength="15" required/>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="validationTooltip02" class="form-control" placeholder="Contraseña" maxlength="10" required/>
                            <div class="invalid-feedback">

<%-- 
    Document   : inscripcioninter2
    Created on : 27/05/2019, 04:10:30 PM
	...
	<section id="global">
		...
		<div class="col-12 ">
			<div id="noti" class="alert alert-danger col-6" role="alert">
			  <p> Verifica tus datos si son correctos, en caso contrario acude al departamento de gestión escolar de tu unidad acádemica. </p>
			</div>
		</div>
		...
		<form class="needs-validation" novalidate>
			<div class="form-row">
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" value="Apellido Patarno" disabled/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    ...
			    <div class="col-md-4 mb-3">
				     ...
				     <input type="text" class="form-control" id="validationTooltip01" value="CURP" disabled/>
				     <div class="valid-tooltip">
				     	OK
				     </div>
		    	</div>
			    ...
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" value="Fecha de nacimiento" disabled/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" value="Lugar de nacimiento" disabled/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" value="Sexo" disabled/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>
			    <div class="col-md-4 mb-3">
				    ...
				    <input type="text" class="form-control" id="validationTooltip02" value="Correo electronico" disabled/>
				    <div class="valid-tooltip">
				    	OK
				    </div>
			    </div>

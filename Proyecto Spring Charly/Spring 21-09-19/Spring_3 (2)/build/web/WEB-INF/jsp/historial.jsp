	...
	<section id="global">
		...
		<div class="col-12 ">
			<div id="noti" class="alert alert-light col-5" role="alert">
			  <p> Aquí verás los eventos en los que has participado durante tu trayectoria académica. </p>
			</div>
		</div>
                <div class="container">
						...
						<tbody>
							...
							<tr>
								...
								<td>Fila 1 Columna 2</td>
                                    ...
                                    <a href="principalalum.htm"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn btn-outline-success"> Regresar </button></a>
				</div>	
			</div>
	</section>
</body>

        ...
        <section id="global">
            ...
            <nav id="bar">
                <ul>
                    ...
                    <li><a href="VistaCoordinadores.htm"><span class="segundo"><i class="fas fa-home"></i></span> Coordinador de U.A. </a></li>
                    ...
                    <li><a href="VistaResultadosJFD.htm"><span class="quinto"><i class="fas fa-sign-in-alt"></i></span> Resultados </a></li>
                </ul>
            </nav>

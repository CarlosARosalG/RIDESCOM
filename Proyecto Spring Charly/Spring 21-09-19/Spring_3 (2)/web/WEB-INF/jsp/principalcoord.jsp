        ...
        <section id="global">
            ...
            <nav id="bar">
                <ul>
                    ...
                    <li><a href="VistaEntrenadores.htm"><span class="segundo"><i class="fas fa-home"></i></span> Entrenadores </a></li>
                    ...
                    <li><a href="VistaResultadosCoord.htm"><span class="quinto"><i class="fas fa-sign-in-alt"></i></span> Resultados </a></li>

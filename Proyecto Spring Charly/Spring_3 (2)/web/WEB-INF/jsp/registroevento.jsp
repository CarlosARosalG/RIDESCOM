			...
			<form class="needs-validation" novalidate>
				<div class="form-row">
			    	<div class="col-md-4 mb-3">
					     ...
					     <input type="text" class="form-control" id="validationTooltip01" placeholder="Nombre evento" required>
			    	...
			    	<div class="col-md-4 mb-3">
				    	...
				    	<input type="text" class="form-control" id="validationTooltip02" placeholder="Fecha del evento" required>
				    	<div class="valid-tooltip">
				      		OK
				    	</div>
				    </div>
				    <div class="col-md-4 mb-3">
					    ...
					    <input type="text" class="form-control" id="validationTooltip02" placeholder="Fecha inicio de registro" required>
					    <div class="valid-tooltip">
					    	OK
					    </div>
				    </div>
				    <div class="col-md-4 mb-3">
					    ...
					    <input type="text" class="form-control" id="validationTooltip02" placeholder="Fecha fin de registro" required>
					    <div class="valid-tooltip">
					    	OK
					    </div>
				    </div>
			  	...
			  	<div class="form-row">
				    ...
				    <div class="col-md-2 mb-2">
				    	<label for="validationTooltip03">Calendario</label>

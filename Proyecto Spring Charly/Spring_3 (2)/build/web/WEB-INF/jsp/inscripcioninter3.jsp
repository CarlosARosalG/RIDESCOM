	...
	<section id="global">
		...
		<form class="needs-validation" novalidate>
			<div class="form-row">
				...
				<!-- Material checked -->
				<p>
					<h4> Selecciona la prueba en la que quieres participar: </h4>
				</p>
				<div class="form-row">
					...
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
					  <label class="form-check-label" for="inlineCheckbox2">Opción 3</label>
					</div>
					<div class="form-check form-check-inline">
					  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="option2">
					  <label class="form-check-label" for="inlineCheckbox2">Opción 4</label>
					</div>
				</div>

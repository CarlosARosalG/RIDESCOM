<%-- 
    Document   : Usuario
    Created on : 2/05/2019, 12:44:58 PM
    Author     : spy51
--%>
...
<body id="fon">
	...
	<!-- Menú -->
		<nav id="bar">
			<ul>
				...
				<li><a href="inscripcioninter2.htm"><span class="segundo"><i class="fas fa-calendar"></i></span> Inscribir interpolitécnico </a></li>
				...
				<li><a href="iniciasesion.html"><span class="quinto"><i class="fas fa-sign-in-alt"></i></span> Consulta tus registros </a></li>
	...
	<!-- Calendario -->
            <a name="calendario" id="calendario"></a>
	...
	<!-- Resultados --> 	
            <a name="resultados" id="resultados"></a>
		...
		<div class="container">
			<div class="cuadro">
				<div class="box">
					...
					<div class='details'><h3><a href="https://www.google.com.mx/maps/place/Escuela+Superior+de+Cómputo/@19.4475565,-99.1791404,12z/data=!4m5!3m4!1s0x0:0x5f2dd0563ce99e8!8m2!3d19.5046538!4d-99.1468517" style='text-decoration:none;color:white;'> ESCOM </a></h3></div>
				</div>
				<div class="box">

<%-- 
    Document   : iniciasesionCord
    Created on : 24/04/2019, 12:08:40 PM
...
Fecha: 16/03/19
Titulo: Inicio Sesion alumno
Funciones: Será la vista para el inicio de sesion del coordinador
-->
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST">
                            <div class="input-group form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Usuario" name="regno"  maxlength="10" required/>
                            ...
                            <button type="submit" class="btn btn-light float-right login_btn"> Cancelar </button>
                            <button type="submit" class="btn btn-light float-right login_btn"> Registrar </button>
                        </form>
                    </div>

                ...
                <form class="needs-validation" novalidate>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="validationTooltip01" class="form-control" placeholder="Nombre evento" maxlength="30" required/>
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="validationTooltip02" placeholder="Dirección" required/>
                            <div class="invalid-feedback">
                                Ingresa un usuario
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="validationTooltip04" placeholder="Sede" required>
                            <div class="invalid-feedback">
                                Ingresa un usuario
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip04"> Punto de referencia </label>
                            <input type="text" class="form-control" id="validationTooltip04" placeholder="Punto de referencia">
                            <div class="invalid-feedback">
                                Ingresa un usuario
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="validationTooltip02" placeholder="Semestre" disabled>
                            <div class="invalid-feedback">
                                Ingresa un usuario
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip03"> Fecha inicio de registro </label>
                            <input type="text" class="form-control" id="datepicker" placeholder="Fecha de inicio" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip03"> Fecha fin de registro </label>
                            <input type="text" class="form-control" id="datepicker1" placeholder="Fecha de fin" required>
                            <script>
                    ...
                    <div>
                        ...
                        <div class="col-md-3 mb-3">
                            <select id="styledrop" class="custom-select" required>
                                <option value="" selected disabled> Selecciona el deporte </option>

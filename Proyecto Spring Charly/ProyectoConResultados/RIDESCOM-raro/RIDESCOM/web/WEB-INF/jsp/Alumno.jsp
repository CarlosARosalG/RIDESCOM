        ...
        <section id="global">
            ...
            <nav id="bar">
                <ul>
                    ...
                    <li><a href="Alumno/Entrenadores" style='text-decoration:none; color: #fff'><span class="segundo"><i class="fas fa-users"></i></span> Entrenadores </a></li>
                    <li><a href="Alumno/DifundirEvento"><span class="tercero" style='text-decoration:none; color: #fff'><i class="fas fa-share-alt"></i></span> Difundir Evento </a></li>
                    <li><a href="Alumno/AlumnosInscritos"><span class="cuarto" style='text-decoration:none; color: #fff'><i class="fas fa-users"></i></span> Consulta Inscritos </a></li>
                    <li><a href="Alumno/Cedulas"><span class="quinto" style='text-decoration:none; color: #fff'><i class="fas fa-book-open"></i></span> Cédulas de Inscripción </a></li>
                    <li><a href="Alumno/Resultados" style='text-decoration:none; color: #fff'><span class="sexto"><i class="fas fa-poll"></i></span> Resultados </a></li>

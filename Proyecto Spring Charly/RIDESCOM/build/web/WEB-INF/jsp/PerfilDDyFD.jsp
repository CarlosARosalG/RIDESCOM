                ...
                <form class="needs-validation" novalidate>
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input name="Nombre_U" type="text" id="validationTooltip01" class="form-control" value="" maxlength="30" required/>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="validationTooltip02"> Rol del Usuario </label>    
                            <input name="Rol" type="text" class="form-control" id="validationTooltip02" value="dato del rol" disabled>

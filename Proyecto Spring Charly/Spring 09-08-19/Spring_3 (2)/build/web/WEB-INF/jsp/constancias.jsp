...
<head>
	<head>
	<meta charset="utf-8">
	<title> Consulta para expedir constancias </title>
...
<body>
	<section id="global">
		<div id="titulo">
			<h1> Consulta para expedir constancias </h1>
		</div>

		<div class="col-12 ">
			<div id="noti" class="alert alert-light col-5" role="alert">
			  <p> Puede buscar a un alumno para verificar que este participó en un evento interpolitecnico. </p>
			</div>
		</div>
		...
		<!-- Formulario --> 
                <form class="needs-validation" novalidate>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="deporte" class="custom-select" required>
                                <option value="" selected disabled>Selecciona una unidad acádemica</option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="deporte" class="custom-select" required>
                                <option value="" selected disabled>Selecciona una deporte</option>
                    ...
                    <a href="principalcoord.htm"style='text-decoration:none;color: #FFFFFF;'> <button type="button" class="btn btn-outline-success"> Regresar </button></a>
                </form>
                <div class="container">

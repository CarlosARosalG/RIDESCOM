...
public class Persona {
    ...
    public Persona(int ID_Persona, String Nombre, String Ap_Pat, String Ap_Mat, int Tipo_Sexo_ID, String CURP, String Fecha_Nac, String NSS, int Usuario_Usuario_ID, String Municipio_ID_Municipio, String Municipio_Estados_ID_estado) {
    ...
    public int getTipo_Sexo_ID() {
        return Tipo_Sexo_ID;
    }

    public void setTipo_Sexo_ID(int Tipo_Sexo_ID) {
        this.Tipo_Sexo_ID = Tipo_Sexo_ID;
    }

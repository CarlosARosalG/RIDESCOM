...
<body id="fon">
	...
	<!-- Menú -->
		<nav id="bar">
			<ul>
				<li><a href="#"><span class="primero"><i class="fas fa-home"></i></span> Eventos </a></li>
				<li><a href="#"><span class="segundo"><i class="fas fa-calendar"></i></span> Resultados </a></li>
				<li><a href="#calendario"><span class="tercero"><i class="fas fa-calendar"></i></span> Entrenadores </a></li>
				<li><a href="#resultados"><span class="cuarto"><i class="fas fa-poll"></i></span> Coordinadores </a></li>
				<li><a href="iniciosesion.htm"><span class="quinto"><i class="fas fa-sign-in-alt"></i></span> Contacto </a></li>
	...
	<!-- Calendario -->
		...
		<h2 id="titulo">Consulta coordinadores de U.A.</h2>
                <div id="agregaboton">
                    ...
                    <a href="Registracord.htm" style='text-decoration:none;color: #777620; align-content: right;'> 
                        <i class="far fa-plus-square"></i> 
                    </a> 
                </div>
                <div class="container">
					...
					<table class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td>Fila 1 Columna 2</td>
                                                                <td> 
                                                                    <a href="editarcoord.htm" style='text-decoration:none;color: #0174DF;'> 
                                                                        <i class="far fa-edit"></i>  
                                                                    </a> 
                                                                </td>
                                                                <td> 

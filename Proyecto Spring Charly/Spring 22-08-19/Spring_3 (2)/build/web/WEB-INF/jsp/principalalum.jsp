...
<body id="fon">
	...
	<!-- Menú -->
		<nav id="bar">
			<ul>
				<li><a href="#calendario"><span class="primero"><i class="fas fa-home"></i></span> Calendario </a></li>
				<li><a href="inscripcioninter2.htm"><span class="segundo"><i class="fas fa-calendar"></i></span> Inscribe Interpolitecnico </a></li>
				<li><a href="historial.htm"><span class="tercero"><i class="fas fa-calendar"></i></span> Historial </a></li>
				<li><a href="#resultados"><span class="cuarto"><i class="fas fa-poll"></i></span> Resultados </a></li>
				<li><a href="iniciosesion.htm"><span class="quinto"><i class="fas fa-sign-in-alt"></i></span> Eventos inscritos </a></li>
				<li><a href="#Contacto"><span class="sexto"><i class="fas fa-address-book"></i></span> Contacto </a></li>
<!--				<li><a href="#"><span class="septimo"><i class="fas fa-user"></i></span> Eventos inscritos </a>
					<ul>

    ...
    <head>
        ...
        <style type="text/css">
            ...
            * {
            ...
            /*Separacion entre cuadro y cuadro*/
            @media (min-width: 1000px) {
                #timeline .demo-card {
                    max-width: 450px;
                    height: 400px;
            ...
            /*Editar Cuadro de texto de cada etiqueta*/
            ...
            /*Ajuste del cuadro del texto de cada etiqueta*/
            @media (min-width: 1000px) {
                #timeline .demo-card .body {
                    height: auto;
                    width: 400px;
...
<body id="fon">
    <section id="global">
        ...
        <nav id="bar">
            <ul>
                <li><a href="#"><span class="primero"><i class="fas fa-user"></i></span> ${Nombre_U} </a>
                    <ul id="Usuario">
                ...
                <li><a href="#"><span class="segundo"><i class="fas fa-home"></i></span> Inicio </a></li>
                ...
                <li><a href="DDyFD/Pruebas"><span class="quinto"><i class="fas fa-poll"></i></span> Pruebas </a></li>
            ...
            <div class="demo-card-wrapper">
                <div class="demo-card demo-card--step1">
                    <div class="head">
                        ...
                        <h2> Evento Atletismo </h2>
                    </div>
                    <div class="body">
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                            Soluta reiciendis deserunt doloribus consequatur, laudantium odio dolorum laboriosam.
                            <ul>
                                <li> Descripción: </li>

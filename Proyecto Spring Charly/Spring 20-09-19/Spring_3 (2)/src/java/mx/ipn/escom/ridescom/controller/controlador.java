...
public class controlador {
    ...
    @RequestMapping(value = "principalJFD1.htm", method = RequestMethod.GET)
    public ModelAndView Listar1(){
        mav1.setViewName("principalJFD1");
        return mav1;
    }
    ...
    @RequestMapping(value="consultainscritos.htm", method = RequestMethod.GET)
    public ModelAndView consultainscritos(){
        String saql = "select ae.ALUMNO_ID_ALUMNO, ae.EVENTO_EVENTO_ID "
                    + "from ALUMNO_HAS_EVENTO"
                    + "WHERE ALUMNO_ID_ALUMNO = #alumno"
                    + "alumno", alumnoId;
        mav1.setViewName("consultainscritos");
        return mav1;
    }
    
    @RequestMapping(value="constancias.htm", method = RequestMethod.GET)
    public ModelAndView constancias(){
        String saql = "select ae.ALUMNO_ID_ALUMNO, ae.EVENTO_EVENTO_ID "
                    + "from ALUMNO_HAS_EVENTO"
                    + "WHERE ALUMNO_ID_ALUMNO = #alumno"
                    + "alumno", alumnoId;
        mav1.setViewName("constancias");
        return mav1;
    }
...
"	from Evento e; ";
    ...
    @RequestMapping(value = "VistaResultadosJFD.htm", method = RequestMethod.GET)
    public ModelAndView VistaVistaResultadosJFD(){
        mav1.setViewName("VistaResultadosJFD");
        return mav1;
    }
    
    @RequestMapping(value = "VistaResultadosCoord.htm", method = RequestMethod.GET)
    public ModelAndView VistaVistaResultadosCoord(){
        mav1.setViewName("VistaResultadosCoord");
        return mav1;
    }
    
    @RequestMapping(value = "VistaResultadosAlum.htm", method = RequestMethod.GET)
    public ModelAndView VistaResultadosAlum(){
        mav1.setViewName("VistaResultadosAlum");
        return mav1;
    }
    
    @RequestMapping(value = "VistaEntrenadores.htm", method = RequestMethod.GET)
    public ModelAndView VistaEntrenadores(){
        mav1.setViewName("VistaEntrenadores");
        return mav1;
    }
    
    @RequestMapping(value = "VistaCoordinadores.htm", method = RequestMethod.GET)
    public ModelAndView VistaCoordinadores(){
        mav1.setViewName("VistaCoordinadores");
        return mav1;
    }

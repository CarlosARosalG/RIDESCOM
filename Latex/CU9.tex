\begin{UseCase}{CU9}{Eliminar datos del Eventos Deportivos}{
		...
		Para ello el Jefe de Fomento Deportivo dará click en el botón \IUbutton{ Eliminar } ubicado en la  parte derecha de la tabla de calendario dentro de la \IUref{}{Pantalla de Principal \ref{principalJFD}}.	
	} \label{CU9_evento}

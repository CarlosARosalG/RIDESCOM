\begin{UseCase}{CU1}{Iniciar Sesión}{
    ...
    \UCpaso[\UCactor] Oprime el botón \IUbutton{ Iniciar Sesión } que esta en la pantalla \IUref{p19Iniciogeneral}{Pantalla principal general.}.
    \UCpaso Muestra la pantalla \IUref{p1Login}{Pantalla de Inicio de Sesión.}.

\begin{UseCase}{CU8}{Editar datos del Eventos Deportivos}{
		...
		Para ello el Jefe de Fomento Deportivo dará click en el botón \IUbutton{ Editar } ubicado en la  parte derecha de la tabla de calendario dentro de la \IUref{}{Pantalla de Principal \ref{principalJFD}}.	
	} \label{CU8_evento}

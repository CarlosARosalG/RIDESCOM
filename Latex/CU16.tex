\begin{UseCase}{CU16}{Agregar Pruebas}{
		\noindent Esta caso de uso servirá para que el Jefe de Fomento Deportivo pueda agregar pruebas de las distintas Actividades Deportivas registradas.
    ...
    \UCpaso[\UCactor] Oprime el botón \IUbutton{ Agregar } en la \IUref{}{Pantalla Editar una Prueba\ref{pruebas}}.
    \UCpaso Muestra la \IUref{}{Pantalla Editar un Agregar Coordinador \ref{editarpruebas}}. 

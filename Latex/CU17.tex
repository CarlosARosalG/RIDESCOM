\begin{UseCase}{CU17}{Editar datos de las Pruebas}{
		\noindent Esta caso de uso servirá para que el Jefe de Fomento Deportivo pueda editar los datos de las pruebas registradas previamente registrado con la finalidad de que si llega a presentar un cambio en e la prueba pueda ser editado sin problema alguno.
		Para ello el Jefe de Fomento Deportivo dará click en el botón \IUbutton{ Editar } ubicado en la  parte derecha de la tabla de Pruebas dentro de la \IUref{}{Pantalla de Pruebas \ref{principalJFD}}.	
	} \label{CU17_evento}
x
		\UCitem{Versión}{0.1}
    ...
    \UCpaso Muestra la \IUref{}{Pantalla principal \ref{pruebas}}.
    \end{UCtrayectoria}

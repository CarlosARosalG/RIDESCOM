\begin{UseCase}{CU2}{Iniciar Sesión Coordinador de Unidad Académica}{
		\noindent Esta caso de uso servirá para que el Coordinador de Unidad Académica pueda ingresar a la página web, poder identificar al usuario y así mostrar las vistas que tienen asginada. \\
		...
		\UCitem{Salidas}{
		\begin{itemize}
		    \item Acceso a la página principal del Coordinador de Unidad Académica
		\end{itemize}}
	...
	\UCpaso[\UCactor] Introduce Usuario y contraseña. \label{CU2_regresar} 
    ...
    \UCpaso Muestra la \IUref{}{Pantalla principal del Jefe de Fomento Deportivo. \ref{principalcoord}}
    \end{UCtrayectoria}
    
    \begin{UCtrayectoriaA}{A}{Campo(s) vacios}
    	\UCpaso muestra mensaje “CamposNecesario".
    	\UCpaso Continua en el paso \ref{CU2_regresar} del \UCref{CU2}.
    \end{UCtrayectoriaA}
